...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public void zeroGyroscope() {
        ...
        m_pigeon.setYaw(0.0, 50);
    }

    /**
     * updates the current gyro yaw. this update is asynchronous and while it waits
     * 50ms for the update, the actual update may take longer.
     * 
     * @param yawDegrees
     */
    ...
    public void setOdometryPose(Pose2d botPose) {
        ...
        RobotContainer.m_drivetrainSubsystem.setGyroScope(botPose.getRotation().getDegrees());
        DataLogManager
