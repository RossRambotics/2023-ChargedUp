...
public class Arm extends SubsystemBase {
  ...
  public Arm() {
    ...
    GraphCommandNode B = m_graphCommand.new GraphCommandNode("B", null, null, null);
    ...
    GraphCommandNode G = m_graphCommand.new GraphCommandNode("G", null, null, null);
    GraphCommandNode H = m_graphCommand.new GraphCommandNode("H", null, null, null);
