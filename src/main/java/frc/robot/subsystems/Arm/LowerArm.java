...
public class LowerArm extends ProfiledPIDSubsystem {
    ...
    public LowerArm() {
        ...
        DataLogManager.log("Lower Arm Encoder Error Code: " + e);
        DataLogManager.log("Lower Arm Position: " + m_encoder.getPosition()); // prints the position of the CANCoder
        DataLogManager.log("Lower Arm absolute Position: " + m_encoder.getAbsolutePosition());

        ErrorCode error = m_encoder.getLastError(); // gets the last error generated by the CANCoder
        CANCoderFaults faults = new CANCoderFaults();
        ErrorCode faultsError = m_encoder.getFaults(faults); // fills faults with the current CANCoder faults; returns
                                                             // the
                                                             // last error generated

        m_encoder.setStatusFramePeriod(CANCoderStatusFrame.SensorData, 10); // changes the period of the sensor data
                                                                            // frame
                                                                            // to 10ms
