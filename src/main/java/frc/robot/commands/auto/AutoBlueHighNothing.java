...
public class AutoBlueHighNothing extends CommandBase {
    /**
     * Creates a new AutoHighNothing
     * .
     */
    public AutoBlueHighNothing() {
    ...
    public void initialize() {
        ...
        SequentialCommandGroup command = new SequentialCommandGroup(
                ...
                SnapDriveToPoseField.createRelative(AutoPoses.BlueNine, 0.5, 0, 0, 0.10),
