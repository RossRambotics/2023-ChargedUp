...
public class AutoPoses {
    ...
    public final static Pose2d GP_BlueNine = new Pose2d(6.7, 0.8, new Rotation2d(Math.toRadians(180)));

    public final static Pose2d BlueOne = new Pose2d(1.88, 4.96, new Rotation2d(Math.toRadians(180)));
    public final static Pose2d BlueTwo = new Pose2d(1.88, 4.43, new Rotation2d(Math.toRadians(180)));
    public final static Pose2d BlueThree = new Pose2d(1.88, 3.88, new Rotation2d(Math.toRadians(180)));
    public final static Pose2d BlueFour = new Pose2d(1.88, 3.30, new Rotation2d(Math.toRadians(180)));
    ...
    public final static Pose2d BlueEight = new Pose2d(1.88, 1.06, new Rotation2d(Math.toRadians(180)));
    ...
    public final static Pose2d RedFour = new Pose2d(14.63, 2.18, new Rotation2d(Math.toRadians(0)));
    public final static Pose2d RedFive = new Pose2d(14.63, 2.73, new Rotation2d(Math.toRadians(0)));
    public final static Pose2d RedSix = new Pose2d(14.63, 3.30, new Rotation2d(Math.toRadians(0)));
    public final static Pose2d RedSeven = new Pose2d(14.63, 3.87, new Rotation2d(Math.toRadians(0)));
    public final static Pose2d RedEight = new Pose2d(14.63, 4.43, new Rotation2d(Math.toRadians(0)));
